...
<div class="modal-body">
                ...
                <input type="text" name="txt_codigo" id="txt_codigo" class="form-control" placeholder="e123" required>
...
<select id="drop_puesto" name="drop_puesto" class="form-control">
    <% 
        // Crear una instancia de la clase Puesto
        Puesto puesto = new Puesto();

        // Obtener los datos del método drop_sangre()
        HashMap<String, String> drop = puesto.drop_sangre();
        
        // Verificar si hay datos y agregarlos al dropdown
        if (drop != null && !drop.isEmpty()) {
            for (String i : drop.keySet()) {
                out.println("<option value='" + i + "'>" + drop.get(i) + "</option>");
            }
        } else {
            out.println("<option value=''>No hay datos disponibles</option>");
        }
    %>  
</select>
